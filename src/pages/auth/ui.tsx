...
import { Login, SignUp, ForgotPassword, ResetPassword } from "widgets/auth";
import LogoLight from "assets/images/logo-light.svg";
import LogoDark from "assets/images/logo-dark.svg";
import { useTheme } from "shared/ui/Theme/useThemes";
import { ThemeProvider } from "shared/ui";
import { NotFoundPage } from "pages/NotFoundPage";
import { BillingConfirm } from "features/Auth/BillingConfirm";
    ...
    <div className={style.container}>
      <section className={style.wrapper}>
        ...
        <div className={style.form__container}>
          <Link to="/" className={style.logo__link_small}>
            <img src={logo} alt="logo" />
          </Link>
          {children}
        </div>
